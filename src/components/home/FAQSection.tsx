...
const faqs = [
  ...
  { q: "Como funciona o modelo de contratação?", a: "Na Move AI, nós oferecemos testes gratuitos de 7 dias. Após esse período, seguimos com um modelo de contratação próprio, ajustado ao seu sistema e às tarefas que o cliente utiliza hoje, com prazos de 3 e 6 meses." },
