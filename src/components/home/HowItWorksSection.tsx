...
const steps = [
  ...
  { icon: Search, number: "02", title: "Mapeamento", description: "Analisamos seu sistema e identificamos exatamente o que automatizar com maior impacto." },
  { icon: Code, number: "03", title: "Implementação", description: "Desenvolvemos e entregamos a solução em 2-3 dias. Você acompanha em tempo real." },
  { icon: Rocket, number: "04", title: "Lançamento", description: "Ativamos a automação com suporte completo na fase de go-live." },
  { icon: TrendingUp, number: "05", title: "Escala", description: "Monitoramos, otimizamos e expandimos continuamente conforme seu negócio cresce." },
];
